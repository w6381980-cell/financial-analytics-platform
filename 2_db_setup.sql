...
SELECT COUNT(*) AS stock_rows     FROM stocks;      -- 3650 hona chahiye
SELECT COUNT(*) AS financial_rows FROM financials;  -- 40 hona chahiye
SELECT TOP 3 * FROM vw_pl_summary; 

SELECT COLUMN_NAME 
FROM INFORMATION_SCHEMA.COLUMNS 
WHERE TABLE_NAME = 'stocks';

-- Table ka data bhi dekho
SELECT TOP 3 * FROM stocks;
